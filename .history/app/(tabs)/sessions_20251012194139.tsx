            ...
            <>
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <LinearGradient colors={['#7ab4cd', '#4f9dbf', '#2f7fa4']}  // tweak as you like
                                start={{ x: 0, y: 0 }}
                                end={{ x: 1, y: 1 }}
                                ...
                                <ScrollView automaticallyAdjustKeyboardInsets>
                                    ...
                                    <View style={styles.metaRow}>
                                        <Text style={styles.metaLight}>
                                            <Text style={styles.metaLabelLight}>Date: </Text>
                                            {selectedSession?.date}
                                        </Text>

                                        <View style={{ flex: 1, marginLeft: 20 }}>
                                            <Text style={styles.metaLight} numberOfLines={2} ellipsizeMode="tail">
                                                <Text style={styles.metaLabelLight}>Location: </Text>
                                    ...
                                    <Text style={styles.metaLight}>
                                        <Text style={styles.metaLabelLight}>Time: </Text>
                                        {selectedSession?.time}
                                    </Text>

                                    <Text style={[styles.metaLight, { marginTop: 10 }]}>
                                        <Text style={styles.metaLabelLight}>Description: </Text>
...
const styles = StyleSheet.create({
    ...
    modalCard: { width: '88%', backgroundColor: '#93bdd7ff', borderRadius: 12, borderWidth: 3, padding: 16, ...Platform.select({ ios: { shadowOffset: { width: 2, height: 2 }, shadowColor: '#000000ff', shadowOpacity: 0.3, shadowRadius: 4, }, android: { elevation: 6 } }) },
    loginBtn: {
        backgroundColor: "#003d53ff",
        paddingVertical: 12,
        borderRadius: 8,
    ...
    statusUpcoming: { color: '#006613ff', fontWeight: 'semibold' },
    statusExpired: { color: '#b50000ff', fontWeight: 'semibold' },
