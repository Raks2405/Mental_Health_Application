...
import { KeyboardAvoidingView, Modal, Platform, Pressable, StyleSheet, Text, TextInput, View, ScrollView } from "react-native";
...
export default function Sessions() {
    ...
    if (user?.email === 'Admin') {
                        ...
                        <Modal visible={addSessions} transparent animationType="fade" onRequestClose={() => setAddSessions(false)}>
                            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} style={styles.centered}>
                                ...
                                <View style={styles.modalCard}>
                                    <ScrollView
        style={{ flex: 1 }}
        contentContainerStyle={{ paddingBottom: 12 }} // small, not huge
      ...
      ></ScrollView>
                                    ...
                                    <TextInput placeholder="Description" style={styles.adminSessionDescription} multiline numberOfLines={9} value={description} onChangeText={setDescription} />
