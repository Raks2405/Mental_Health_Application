                ...
                >
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} style={styles.centered}>
                        ...
                        <View style={styles.modalCard}>
                            <Text style={{ fontWeight: '700', fontSize: 18, padding: 'auto' }}>{selectedSession?.title}</Text>
                            <Text style={{padding: 'auto'}}>Date: {selectedSession?.date}</Text>
                            <Text style={{padding: 'auto'}}>Time: {selectedSession?.time}</Text>
                            <Text style={{padding: 'auto'}}>Location: {selectedSession?.location}</Text>
