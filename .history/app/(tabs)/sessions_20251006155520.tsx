                ...
                >
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} style={styles.centered}>
                        ...
                        <View style={styles.modalCard}>
                            ...
                            <Text style={{margin: 'auto'}}>Date: {selectedSession?.date}</Text>
                            <Text style={{margin: 'auto'}}>Time: {selectedSession?.time}</Text>
                            <Text style={{margin: 'auto'}}>Location: {selectedSession?.location}</Text>
