                        ...
                        <Modal visible={addSessions} transparent animationType="fade" onRequestClose={() => setAddSessions(false)}>
                            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.centered}>
                                ...
                                <View style={styles.modalCard}>
                                    ...
                                    {/* You can add platform-specific components here if needed, for example: */}
                                    {/* {Platform.OS === 'ios' ? (
                                        <TextInput placeholder="Date (iOS)" style={styles.sessionTitle} value={date.toDateString()} editable={false} />
                                    ) : null} */}
                                    {Platform.OS === 'ios' ? (
                                        <Date
                                    ) : null}
