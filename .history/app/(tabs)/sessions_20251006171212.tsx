                    ...
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} style={styles.centered}>
                        ...
                        <View style={styles.modalCard}>
                            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                <Pressable style={{ backgroundColor: '#1f1fb0ff', margin: 3, backgroundSize: 5}}>
                                    <FontAwesome name='edit' size={24} color='white' margin='10' />
                                </Pressable>
                                <Pressable style={{ backgroundColor: '#b01f1fff', margin: 3 , backgroundSize: 5}}>
                                    <FontAwesome name='remove' size={24} color='white' margin='10' />
                                </Pressable>
                            </View>
