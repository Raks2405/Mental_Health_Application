                    ...
                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0} style={styles.centered}>
                        ...
                        <View style={styles.modalCard}>
                            <View style={{ borderRadius: 1, padding: 5, alignItems: 'center' }}>
                                <Text style={{ fontWeight: '700', fontSize: 18, marginBottom: 15 }}>{selectedSession?.title}</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <Text style={{ marginTop: 3 }}>Date: </Text>{selectedSession?.date}
                                <Text style={{ marginTop: 3 }}>Location: </Text>{selectedSession?.location}
                            </View>
