...
export default function Sessionsssss() {
    ...
    const [isOpenedSession, setIsOpenedSession] = useState(false);
    ...
    const handleUserOpenSession = (session: Session) => {
        if (user?.email){
            setIsOpenedSession(true);
        }
    }
                            ...
                            <View style={styles.subCard}>
                                <Pressable
                                    ...
                                    onPress={() => {
                                        ...
                                        handleUserOpenSession(item);
                                    }}
                                >
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text style={{ color: 'red', fontSize: 6, fontWeight: 'thin' }}>{isOpenedSession ? null : "New"}</Text>
