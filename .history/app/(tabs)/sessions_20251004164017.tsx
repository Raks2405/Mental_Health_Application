...
export default function Sessionsssss() {
    ...
    const isFuture = selectedSession?.date ? new Date(selectedSession.date).getTime() > Date.now() : false
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.subCard}>
                            <Pressable style={{ flexDirection: 'column', alignContent: 'space-between' }} onPress={() => setSelectedSession(item)}>
