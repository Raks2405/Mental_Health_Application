...
export default function Sessionsssss() {
    ...
    const [sessionLists, setSessionLists] = useState<Session[] | null>([]);
    ...
    const handleViewDetails = (sessionData: Session) => {
        setSessionLists(sessionData); // Set the specific session data
        setIsDetailModalVisible(true);   // Open the single modal
    };
            ...
            <ScrollView style={{flex: 1}} >
                {
                    ...
                    sessionLists.map((sessions, index) => (
                        <View key={sessions.docId || index} style={styles.subCard}>
