            ...
            <>
                ...
                >
                    ...
                    >
                        ...
                        {/* ⬇️ NO flex:1 wrapper here — it causes compression */}
                        <LinearGradient
                            ...
                            >
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <Pressable
                                                ...
                                                onPress={() => { if (selectedSession) handleEditButton(selectedSession); }}
                                            >
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <Pressable
                                                ...
                                                onPress={() => { if (selectedSession) handleDeleteButton(selectedSession); }}
                                            >
                                ...
                                <View style={styles.scrollWrap}>
                                    <ScrollView
                                        ...
                                        contentContainerStyle={{ paddingHorizontal: 12, paddingBottom: 12 }}  // ⬅️ inner margin
                                    >
                                        {/* Date & Time */}
                        ...
                        <View style={{ flex: 1, }}>
                            ...
                            <Modal visible={addSessions} transparent animationType="fade" onRequestClose={() => setAddSessions(false)}>
                                <KeyboardAvoidingView
                                    behavior={Platform.OS === 'ios' ? 'padding' : undefined}
                                    keyboardVerticalOffset={Platform.OS === "ios" ? 100 : 0}
                                    style={styles.centeredFill}                         // ⬅️ was styles.centered
                                >
                                    ...
                                    <LinearGradient
                                        ...
                                        style={styles.addModalFrame}                      // ⬅️ use add frame
                                    >
                                        <LinearGradient
                                            colors={['rgba(255, 255, 255, 0.36)', 'transparent']}
                                            start={{ x: 0, y: 0 }}
                                        ...
                                        <LinearGradient
                                            ...
                                            style={styles.addModalGlass}                    // ⬅️ use add glass
                                        >
                                            <ScrollView
                                                automaticallyAdjustKeyboardInsets
                                                showsVerticalScrollIndicator
                                                keyboardShouldPersistTaps="handled"
                                                style={{ alignSelf: 'stretch' }}
                                                contentContainerStyle={{ paddingHorizontal: 12, paddingBottom: 16, paddingTop: 4 }}
                                            >
...
const styles = StyleSheet.create({
    ...
    scrollWrap: {
        flex: 1,                   // ⬅️ let it fill remaining height
        minHeight: 0,              // ⬅️ critical on Android to avoid push-out
        alignSelf: 'stretch',
    },
    ...
    addModalFrame: {
        ...
        overflow: 'hidden',
        ...Platform.select({
            ios: { shadowOffset: { width: 0, height: 8 }, shadowColor: '#000', shadowOpacity: 0.35, shadowRadius: 16 },
            android: { elevation: 10 }
        })
    },
    addModalGlass: {
        backgroundColor: 'rgba(0, 125, 160, 0.18)',
        borderRadius: 14,
        paddingVertical: 16,
        paddingHorizontal: 14,
        borderWidth: 1,
