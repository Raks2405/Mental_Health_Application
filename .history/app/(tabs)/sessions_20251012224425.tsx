...
const styles = StyleSheet.create({
  ...
  modalCardGlass: {
    ...
    maxHeight: '100%',
    flex: 1,              // fills the gradient frame
  },
  ...
  scrollWrap: {
    flex: 1,
    minHeight: 0, // critical for Android
  },
