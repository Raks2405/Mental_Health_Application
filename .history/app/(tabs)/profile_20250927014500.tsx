...
export default function Profile() {
    ...
    // prefer route param, fallback to firebase auth user's email, then 'Unknown'
    const paramEmail = Array.isArray(email) ? email[0] : email;
    const displayEmail = paramEmail ?? auth.currentUser?.email ?? 'Unknown';
    ...
    return (
        <View style={styles.card}>
            <View style={styles.name_iconContainer}>
                ...
                <Text style={styles.name}>{displayEmail}</Text>
            </View>
            ...
            <View style={{...styles.subCard,
                 backgroundColor: displayEmail === 'Guest' ? 'lightgray' : 'white',
                 borderColor: displayEmail === 'Guest' ? 'lightgray' : 'white' }}>
                <Pressable
                    disabled={displayEmail === 'Guest'}
                    style={{
                        flexDirection: 'row',
