...
import { adminEmails } from "../../../../../app/(auth)/loginpage";
import { logOut } from '../../../../auth';
import { auth } from '../../../../firebase';
import ThemeBackground from "../../../../shared/ThemeBackground"; // ⟵ add this
...
export default function Profile() {
  ...
  return (
    <ThemeBackground>
      {/* subtle glow over the themed background */}
      <LinearGradient
      ...
      >
        ...
        >
          ...
          {/* keep the nice gradient frame INSIDE the modal */}
          <LinearGradient
