...
import { Alert, Platform, Pressable, StyleSheet, Text, View, Modal, TextInput, KeyboardAvoidingView } from "react-native";
...
export default function Profile() {
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={{...styles.subCard,
                 backgroundColor: email === 'Guest' ? 'lightgray' : 'white',
                 borderColor: email === 'Guest' ? 'lightgray' : 'white' }}>
                <Pressable
                    disabled={email === 'Guest'}
                    style={{
                        flexDirection: 'row',
